...
var ui = H.ui.UI.createDefault(map, defaultLayers); // add UI
...
var url = document.getElementById('pdeEndPoint').value + "/1/static.json?content=SC_TRAFFIC_PATTERN&apikey=" + api_key_jp + "&callback=gotStaticContentTrafficPattern";
var script = document.createElement("script");
script.src = url;
document.body.appendChild(script);