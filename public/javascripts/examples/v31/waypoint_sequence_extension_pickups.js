/*
  ...
  var map = new H.Map(mapContainer, maptypes.vector.normal.map, {center: center, zoom: zoom});
  ...
  var calculateOptimizedRoute = function (mode, startPoint, destinations, endPoint, vehicletype, traffic, departure, arrival, capacity, truckParams, restTimes, driverCost, vehicleCost) {
	...
	var overrideapiKey   = document.getElementById('custom-api-key'  ).value;
	if (overrideapiKey.length > 0 ) {
