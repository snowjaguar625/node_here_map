...
(function setValuesFromUrl() {
  ...
  var isolineOptions = [
    { lineWidth: 3, strokeColor: "rgba(34, 204, 34, 0.5)"},
    { lineWidth: 2, strokeColor: "rgba(204, 204, 34, 0.5)"},
    { lineWidth: 1, strokeColor: "rgba(204, 34, 34, 0.5)"}
  ];
  
  var isolineLinkOptions = [
    { lineWidth: 3, strokeColor: "rgba(0, 38, 255, 0.5)"},
    { lineWidth: 2, strokeColor: "rgba(0, 148, 255, 0.5)"},
    { lineWidth: 1, strokeColor: "rgba(0, 255, 255, 0.5)"}
	];
  ...
  var isolineCallback = function(response){
    ...
    {
      for(var idx = 0; idx < response.isoline.length; idx++) {
        var components = response.isoline[idx].component;
        ...
        for (var j = 0; j < components.length; j++) {
          ...
          if(displayPolygon){
            ...
            shp = new H.map.Polygon(strip, {
              style: isolineOptions[parseInt(idx)]
            });
          ...
          if(displayPolylines){
            ...
            for(var i = 0; i < links.length; i++){
              ...
              var polyline = new H.map.Polyline(linkStrip,{
                style: isolineLinkOptions[parseInt(idx)]
              });
