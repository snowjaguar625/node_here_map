...
var map = new H.Map(mapContainer, maptypes.normal.map, {center: new H.geo.Point(50.11239,8.68598), zoom: 10});
...
function addLinkGeometry(linksToAdd){
  ...
  map.setViewBounds(mapObjects.getBounds());
  Spinner.hideSpinner();
}
