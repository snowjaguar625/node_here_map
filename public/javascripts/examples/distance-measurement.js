...
'<path d="M4 4 L22 4 L22 22 L4 22 L4 4 Z" stroke="rgb(255,255,255)" stroke-width="2" fill="none"/>' +
'<path d="M7 22 L7 8" stroke="rgb(255,255,255)" stroke-width="2" fill="none"/>' +
'<path d="M13 22 L13 8" stroke="rgb(255,255,255)" stroke-width="2" fill="none"/>' +
'<path d="M19 22 L19 8" stroke="rgb(255,255,255)" stroke-width="2" fill="none"/>' +
'<path d="M10 22 L10 14" stroke="rgb(255,255,255)" stroke-width="2" fill="none"/>' +
'<path d="M16 22 L16 14" stroke="rgb(255,255,255)" stroke-width="2" fill="none"/>' +
'<path d="M6 20 L20 20" stroke="rgb(255,255,255)" stroke-width="2" fill="none"/>' +
'</svg>';
...
DistanceMeasurement.prototype.addLine = function (e, i) {
    ...
    if (length > 1) {
        var startCoord = objects[i].getPosition(),
			endCoord = objects[i + 1].getPosition(),
